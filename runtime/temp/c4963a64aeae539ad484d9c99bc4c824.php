...
<script type="text/html" title="操作按钮模板" id="buttonTpl">
    <a href="<?php echo url('editUser'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-normal hisi-iframe"
       hisi-data="{width: '470px', height: '400px'}" title="修改管理员">修改</a><a href="<?php echo url('delUser'); ?>?id={{ d.id }}"
...
<script type="text/html" id="toolbar">
    <div class="layui-btn-group fl">
        <a href="<?php echo url('addUser'); ?>"
           ...
           hisi-data="{width: '470px', height: '400px'}" title="添加管理员">&nbsp;添加</a>
        ...
        <a data-href="<?php echo url('delUser'); ?>"
