        ...
        <div class="layui-form-item layui-form-pane">
            ...
            <div class="layui-input-inline">
                <select name="series_id" id="series_id" lay-verify="required" lay-filter="class_select">
                    ...
                    <option value="<?php echo htmlentities($item['id']); ?>" <?php if($item['id'] == session('series_id')): ?>selected<?php endif; ?>><?php echo htmlentities($item['name']); ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
            ...
            <div class="layui-input-inline">
                <select name="refraction_id" id="refraction_id" lay-verify="required" lay-filter="class_select">
                    ...
                    <option value="<?php echo htmlentities($item['id']); ?>" <?php if($item['id'] == session('refraction_id')): ?>selected<?php endif; ?>><?php echo htmlentities($item['value']); ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
            ...
            <div class="layui-input-inline">
                <select name="film_id" id="film_id" lay-verify="required" lay-filter="class_select">
                    ...
                    <option value="<?php echo htmlentities($item['id']); ?>" <?php if($item['id'] == session('film_id')): ?>selected<?php endif; ?>><?php echo htmlentities($item['name']); ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
        <div class="layui-form-item layui-form-pane">
            ...
            <div class="layui-input-inline">
                <select name="ball" id="ball" lay-verify="required" lay-filter="class_select">
                    ...
                    <option value="1" <?php if(1 == session('ball')): ?>selected<?php endif; ?>>球</option>
                    <option value="0" <?php if(0 == session('ball')): ?>selected<?php endif; ?>>非球</option>
                </select>
            </div>
            <div class="layui-input-inline">
