...
<?php endif; switch($hisiTabType): case "1": ?>
    ...
    <div class="layui-form-item layui-form-pane">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-number" id="number" name="number" lay-verify="required" placeholder="请输入编码">
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-pane">
        ...
        <div class="layui-input-inline">
            <select name="film_id" id="film_id" lay-verify="required" lay-filter="class_select">
                ...
                <?php if(is_array($film_list) || $film_list instanceof \think\Collection || $film_list instanceof \think\Paginator): $i = 0; $__LIST__ = $film_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo htmlentities($item['id']); ?>" <?php if($item['id']==$formData['film_id']): ?>selected<?php endif; ?>><?php echo htmlentities($item['name']); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-pane">
        ...
        <div class="layui-input-inline">
            <select name="series_id" id="series_id" lay-verify="required" lay-filter="class_select">
                ...
                <option value="<?php echo htmlentities($item['id']); ?>" <?php if($item['id']==$formData['series_id']): ?>selected<?php endif; ?>><?php echo htmlentities($item['name']); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-pane">
        ...
        <div class="layui-input-inline">
            <select name="refraction_id" id="refraction_id" lay-verify="required" lay-filter="class_select">
                ...
                <option value="<?php echo htmlentities($item['id']); ?>" <?php if($item['id']==$formData['refraction_id']): ?>selected<?php endif; ?>><?php echo htmlentities($item['value']); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-pane">
        ...
        <div class="layui-input-inline">
            <select name="degree_id" id="degree_id" lay-verify="required" lay-filter="class_select">
                ...
                <option value="<?php echo htmlentities($item['id']); ?>" <?php if($item['id']==$formData['degree_id']): ?>selected<?php endif; ?>><?php echo htmlentities($item['value']); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-pane">
        ...
        <div class="layui-input-inline">
            <select name="astigmatism_id" id="astigmatism_id" lay-verify="required" lay-filter="class_select">
                ...
                <option value="<?php echo htmlentities($item['id']); ?>" <?php if($item['id']==$formData['astigmatism_id']): ?>selected<?php endif; ?>><?php echo htmlentities($item['value']); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
