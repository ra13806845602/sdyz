<?php /*a:2:{s:77:"E:\phpStudy\PHPTutorial\WWW\hisiphp\application\system\view\publics\icon.html";i:1588348082;s:76:"E:\phpStudy\PHPTutorial\WWW\hisiphp\application\system\view\block\layui.html";i:1588348082;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>图标选择</title>
...
<body align="center">
    <div class="layui-tab layui-tab-card">
        <ul class="layui-tab-title">
            <li class="layui-this"><a href="javascript:;">系统默认</a></li>
...
layui.use(['jquery', 'element'], function() {
    ...
    $('.icon-list li').click(function(){
        ...
        parent.document.getElementById('<?php echo input("param.input/s"); ?>').value = _val;
        parent.document.getElementById('<?php echo input("param.show/s"); ?>').setAttribute('class', _val);
