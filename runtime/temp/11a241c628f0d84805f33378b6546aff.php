...
<?php endif; switch($hisiTabType): case "1": ?>
    ...
    <div class="layui-form-item layui-form-pane">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-name" name="name" lay-verify="required" placeholder="请输入系列">
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-pane" style="position: relative;z-index: 10000;">
        ...
        <div class="layui-input-inline">
            <select name="brand_id" id="brand_id" lay-verify="required">
                <option value="">请选择品牌</option>
                <?php if(is_array($brand_list) || $brand_list instanceof \think\Collection || $brand_list instanceof \think\Paginator): $i = 0; $__LIST__ = $brand_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo htmlentities($item['id']); ?>" <?php if($item['id']==$formData['brand_id']): ?>selected<?php endif; ?>><?php echo htmlentities($item['brand_name']); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
