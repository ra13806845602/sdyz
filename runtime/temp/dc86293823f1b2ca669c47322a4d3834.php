...
<div class="page-form">
    ...
    <div class="layui-form-item">
        ...
        <table class="layui-table ml30" lay-even="" lay-skin="row">
            ...
            <tbody>
                <?php if(is_array($formData['module_depend']) || $formData['module_depend'] instanceof \think\Collection || $formData['module_depend'] instanceof \think\Paginator): $i = 0; $__LIST__ = $formData['module_depend'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <tr>
                    <td><?php echo htmlentities($v[0]); ?></td>
                    <td><?php echo htmlentities($v[1]); ?></td>
                    <td><?php echo htmlentities($v[5]); ?></td>
                    <td><?php echo htmlentities($v[2]); ?></td>
                    <td><?php echo $v[4]; ?></td>
                </tr>
                <?php if(($v[4] != '✔︎')): 
                        $error = true;
    ...
    <?php if(($formData['demo_data'])): ?>
    <div class="layui-form-item">
        <label class="layui-form-label">导入演示数据</label>
        <div class="layui-input-inline">
            <input type="radio" name="demo_data" value="1" title="是">
            <input type="radio" name="demo_data" value="0" title="否" checked>
        </div>
    </div>
    <?php endif; ?>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="hidden" name="id" value="<?php echo htmlentities($formData['id']); ?>">
            <button type="submit" <?php if($error): ?>class="layui-btn layui-btn-disabled" disabled<?php else: ?>class="layui-btn layui-btn-normal"<?php endif; ?> lay-submit="" lay-filter="formSubmit">立即安装</button>
