...
<?php endif; switch($hisiTabType): case "1": ?>
    ...
    <div class="layui-form-item layui-form-pane" style="position: relative;z-index: 10000;">
        ...
        <div class="layui-input-inline">
            <select name="brand_id" id="brand_id" lay-verify="required" lay-filter="class_select">
                ...
                <option value="<?php echo htmlentities($item['id']); ?>"><?php echo htmlentities($item['brand_name']); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
