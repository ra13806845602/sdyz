                    ...
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">
                            <?php switch($vo['status']): case "0": ?>
                                    <a data-href="<?php echo url('install?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-ajax">安装</a>
                                    <a data-href="<?php echo url('del?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-del">删除</a>
                                <?php break; case "1": ?>
                                    <a href="<?php echo url('setting?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small">配置</a>
                                    <?php if($vo['app_keys']): ?>
                                        <a href="<?php echo url('upgrade/lists?app_type=plugins&identifier='.$vo['identifier']); ?>" class="layui-btn layui-btn-primary layui-btn-small">更新</a>
                                    <?php endif; ?>
                                    <a href="<?php echo url('uninstall?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small">卸载</a>
                                <?php break; case "2": ?>
                                    <a href="<?php echo url('setting?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small">配置</a>
                                    <?php if($vo['app_keys']): ?>
                                        <a href="<?php echo url('upgrade/lists?app_type=plugins&identifier='.$vo['identifier']); ?>" class="layui-btn layui-btn-primary layui-btn-small">更新</a>
                                    <?php endif; ?>
                                    <a title="卸载后将无法使用此插件，您确定要卸载吗？" data-href="<?php echo url('uninstall?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-ajax">卸载</a>
                                <?php break; default: ?>
                            <?php endswitch; ?>
                        </div>
                    </div>
